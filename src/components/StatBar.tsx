    ...
    <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 pb-5 mb-6 border-b border-border">
      ...
      <div className="flex flex-col gap-2 max-w-[280px] md:text-right leading-snug">
        <p className="text-[10px] text-label-light">
          Tracking only ships within terrestrial AIS range (~30nm of coastal receivers). Vessels mid-ocean won&apos;t appear until they&apos;re near a receiver. A vessel drops out of the en-route count once it&apos;s been silent for 14 days. Tankers that have quietly berthed may linger in the total for up to two weeks.
        </p>
        {msoReserve && (
          <p className="text-[10px] text-label-light">
